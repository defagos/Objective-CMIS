...
//- (NSMutableDictionary *)convertCMISProperties:(CMISProperties *)properties forObjectTypeId:(NSString *)objectTypeId error:(NSError **)error
//{
//    // Validate
//    if (objectTypeId == nil)
//    {
//        *error = [CMISErrors createCMISErrorWithCode:kCMISErrorCodeInvalidArgument
//                             withDetailedDescription:[NSString stringWithFormat:@"Object type must be set"]];
//    }
//    if (properties == nil)
//    {
//        *error = [CMISErrors createCMISErrorWithCode:kCMISErrorCodeInvalidArgument
//                             withDetailedDescription:[NSString stringWithFormat:@"Properties must be set"]];
//    }
//
//    // Iterate through properties and convert
//    for (id key in properties.propertiesDictionary.allKeys)
//    {
//
//    }
//}
